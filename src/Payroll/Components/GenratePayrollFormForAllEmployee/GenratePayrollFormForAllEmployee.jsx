...
const PayrollForm = () => {
    ...
    const handleGetDetails = (id) => {
        handleIdForPayroll(id);  // Set the employee ID in context
        navigate(`/payroll/employee/${id}`);  // Navigate to the employee details page
    };
      ...
      >
        &larr; 
          ...
          <div className="flex justify-between items-center  m-10">
                ...
                >
                 Genrate PayRoll For Single Employee
                </button>
        ...
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
            <h1 className="text-2xl font-semibold text-center mb-6">Genrate  Payroll for All Employee</h1>
